...
# ------Добавление------------------------------------------------------------------------------------------------------
one_post = {
    "_id": ObjectId("012345678901234567890123"),  # "_id": 555
    "author": "Mike",
    "text": "bla bla bla",
...
print(
    f"db.test_collection.find_one({{'author': 'Mike'}}):\n"
...
print(
    f"db.test_collection.find_one({{'author': 'Eliot'}}): {db.test_collection.find_one({'author': 'Eliot'})}\n"
)
...
print(
    f"db.test_collection.find_one({{'_id': {one_post_id}}}):\n"
...
print(
    f"db.test_collection.find_one({{'_id': str({one_post_id})}}): "
...
print(
    f"db.test_collection.count_documents({{}}): {db.test_collection.count_documents({})}\n"
)
...
update_one_result = db.test_collection.update_one(
    {"author": "Ira"}, {"$set": {"text": "Cute frogs"}}
)
print(
    f"db.test_collection.update_one({{'author': 'Ira'}}, {{'$set': {{'text': 'Cute frogs'}}):\n"
    f"\ttype = {type(update_one_result)}\n"
    f"\tvalue = {update_one_result}\n"
)
one_matched_count = update_one_result.matched_count
print(
    f"db.test_collection.update_one({{'author': 'Ira'}}, {{'$set': {{'text': 'Cute frogs'}}).matched_count:\n"
    f"\ttype = {type(one_matched_count)}\n"
    f"\tvalue = {one_matched_count}\n"
)
one_modified_count = update_one_result.modified_count
print(
    f"db.test_collection.update_one({{'author': 'Ira'}}, {{'$set': {{'text': 'Cute frogs'}}).modified_count:\n"
    f"\ttype = {type(one_modified_count)}\n"
    f"\tvalue = {one_modified_count}\n"
)

update_one_result = db.test_collection.update_one(
    {"author": "Cat"}, {"$set": {"text": "Cute frogs"}}
)
print(
    f"db.test_collection.update_one({{'author': 'Cat'}}, {{'$set': {{'text': 'Cute frogs'}}):\n"
    f"\ttype = {type(update_one_result)}\n"
    f"\tvalue = {update_one_result}\n"
)
one_matched_count = update_one_result.matched_count
print(
    f"db.test_collection.update_one({{'author': 'Cat'}}, {{'$set': {{'text': 'Cute frogs'}}).matched_count:\n"
    f"\ttype = {type(one_matched_count)}\n"
    f"\tvalue = {one_matched_count}\n"
)
one_modified_count = update_one_result.modified_count
print(
    f"db.test_collection.update_one({{'author': 'Cat'}}, {{'$set': {{'text': 'Cute frogs'}}).modified_count:\n"
    f"\ttype = {type(one_modified_count)}\n"
    f"\tvalue = {one_modified_count}\n"
)
...
update_many_result = db.test_collection.update_many(
    {"text": "bla bla bla"}, {"$set": {"text": "New cool text"}}
)
print(
    f"db.test_collection.update_many({{'text': 'bla bla bla'}}, {{'$set': {{'text': 'New cool text'}}):\n"
    f"\ttype = {type(update_many_result)}\n"
    f"\tvalue = {update_many_result}\n"
)
many_matched_count = update_many_result.matched_count
print(
    f"db.test_collection.update_many({{'text': 'bla bla bla'}}, "
...
print(
    f"db.test_collection.delete_one({{'author': 'Cat'}}:\n"
    f"\ttype = {type(delete_one_result)}\n"
    f"\tvalue = {delete_one_result}\n"
)
one_deleted_count = delete_one_result.deleted_count
print(
    f"db.test_collection.delete_one({{'author': 'Cat'}}).deleted_count:\n"
    f"\ttype = {type(one_deleted_count)}\n"
    f"\tvalue = {one_deleted_count}\n"
)
...
print(
    f"db.test_collection.delete_many({{'text': {{'$eq': 'bla bla bla'}}}}:\n"
    f"\ttype = {type(delete_many_result)}\n"
    f"\tvalue = {delete_many_result}\n"
)
many_deleted_count = delete_many_result.deleted_count
print(
    f"db.test_collection.delete_many({{'text': {{'$eq': 'bla bla bla'}}}}.deleted_count:\n"
